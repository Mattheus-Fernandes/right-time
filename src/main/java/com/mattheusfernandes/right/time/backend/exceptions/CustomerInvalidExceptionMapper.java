...
@Provider
public class CustomerInvalidExceptionMapper implements ExceptionMapper<CustomerInvalidException> {

    @Override
    public Response toResponse(CustomerInvalidException exception) {
